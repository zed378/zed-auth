...
--
-- PG-14 (TASKS/BACKLOG.md): docs/PLAN/04 § sessions describes the cookie as
...
--
--   * docs/PLAN/05 routes /v1/organizations/{org_id}/users/{user_id}/sessions, so
...
-- and audit.
--
-- Additive and backward-compatible per docs/PLAN/14's expand/contract rule.
