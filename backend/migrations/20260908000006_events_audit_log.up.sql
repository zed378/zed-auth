...
--
-- PLAN/04-DATA-MODEL.md § events and § Retention and Growth.
-- SECURITY/02-ATTACK-SURFACE-AND-SCENARIOS.md §19 (Logging / Audit Integrity).
--
...
--      console's Audit Log screen (PLAN/12).
...
--
-- PLAN/04 § Retention and Growth resolves the GDPR-versus-immutable-audit-log
...
-- Query patterns from UI-UX/08 (Audit Log) and P1-20: recent-first within an
...
COMMENT ON TABLE events IS
  'Append-only audit log, month-partitioned. UPDATE/DELETE revoked from the application role (SECURITY/02 §19). Retention: 24 months hot, then archived; erasure requests pseudonymize rather than delete (PLAN/04 § Retention and Growth, OQ-09).';
