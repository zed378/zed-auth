...
export interface paths {
    ...
    "/saml/sso": {
        ...
        /**
         * SAML single sign-on (HTTP-Redirect binding)
         ...
         */
        get: operations["samlSSORedirect"];
        put?: never;
        /**
         * SAML single sign-on (HTTP-POST binding)
    ...
    "/saml/slo": {
         ...
         */
        post: operations["samlSingleLogout"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface operations {
    ...
    samlMetadata: {
        ...
        requestBody?: never;
        responses: {
            /** @description The identity provider's metadata. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    samlSSORedirect: {
        parameters: {
            query: {
                /** @description The AuthnRequest, DEFLATE-compressed then base64-encoded. */
                SAMLRequest: string;
                /**
                 * @description The service provider's own opaque state. Echoed back unchanged and
                 *     never interpreted. Bounded; an oversized value is refused rather
                 *     than truncated, because a truncated value is one the service
                 *     provider cannot match against anything it stored.
                 */
                RelayState?: string;
            };
            header?: never;
        ...
        requestBody?: never;
        responses: {
            /** @description A self-submitting form delivering the response. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The request is malformed, oversized, or names an unregistered service provider. */
            400: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    samlSSOPost: {
        ...
        requestBody: {
            content: {
                "application/x-www-form-urlencoded": {
                    /** @description The AuthnRequest, base64-encoded. */
                    SAMLRequest: string;
                    RelayState?: string;
                };
            };
