...
Same thing through the console: **Projects → open your project → Register application**.
Opening a project lands you on its applications; there is no second click. It calls this
exact endpoint — the console has no private ones.
