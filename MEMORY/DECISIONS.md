...
None. `PLAN/09` requires that credentials be hashed and does not specify the algorithm per credential type. `PLAN/04` already models `client_secret_hash` as opaque text.
